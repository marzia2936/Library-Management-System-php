...
<?php
	...
	if(isset($_POST['save'])) 
	{
		...
		$sql = "INSERT INTO book_collection_info (book_id, total_number_of_books, total_issued_books, total_available_books) values('$book_id', '$total_number_of_books', '$total_issued_books','$total_available_books')";
        ...
        <div class="row mt">
          <div class="col-lg-12">
            <div class="form-panel">
              <h4 class="mb"></h4>
              <form class="form-horizontal style-form" method="post" action="book_collection_info.php">
			  ...
			  <div class="form-group">
				...
				<div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control" name="total_number_of_books">
                  </div>
                </div>
				...
				<div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control" name="total_issued_books">
                  </div>
                </div>
				<div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Total Available Books :</label>
                  <div class="col-sm-6">
                    <input type="text" class="form-control" name="total_available_books">
                  </div>
                </div>
