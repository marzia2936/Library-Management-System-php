...
<?php
	...
	if(isset($_POST['save'])) 
	{
		...
		$sql = "INSERT INTO role_info ( role_info_id, role_info_name,role_info_email, role_description) values('$role_info_id','$role_info_name','$role_info_email','$role_description')";
        ...
        <div class="row mt">
          <div class="col-lg-12">
            <div class="form-panel">
              <h4 class="mb"></h4>
              <form class="form-horizontal style-form" method="post" action="role_info.php">
			  
			  <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Role Info ID :</label>
                  <div class="col-sm-6">
                    <input type="text" class="form-control" name="role_info_id">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control" name="role_info_name">
                  </div>
                </div>
				 <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Role Info Email :</label>
                  <div class="col-sm-6">
                    <input type="text" class="form-control" name="role_info_email">
                  </div>
                </div>
