...
<?php
	...
	{ 
		...
		$sql = "INSERT INTO supplier_info(sup_id,sup_name,sup_email,sup_contact_no) values('$sup_id','$sup_name' ,'$sup_email', '$sup_contact_no')";
        ...
        <div class="row mt">
          <div class="col-lg-12">
            <div class="form-panel">
              <h4 class="mb"></h4>
              <form class="form-horizontal style-form" method="post" action="supplier_info.php">
				...
				<div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control" name="sup_contact_no">
                  </div>
                </div>
