...
<?php
	...
	if(isset($_POST['update'])) 
	{
		...
		$sql = "UPDATE user_info set id='$id',username='$username',password='$password',contact='$contact',status='$status' WHERE id='$id'";
		...
		if($result) 
		{
			...
			echo "<meta http-equiv='refresh' content='2;url=users_listview.php'>";
			exit();
		}
	}
      ...
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
		  ...
		  <li class="sub-menu">
            ...
            <ul class="sub">
               <li><a href="users_listview.php">All User Information Information</a></li>
        ...
        <div class="row mt">
          <div class="col-lg-12">
            <div class="form-panel">
              <h4 class="mb"></h4>
              <form class="form-horizontal style-form" method="post" action="edit_user_info.php">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
				  <label class="col-sm-6 col-sm-6 control-label"><?php  echo $username;   ?></label>
                  </div>
                </div>
				...
				<div class="form-group">
                  ...
                  <div class="col-sm-6">
				  <label class="col-sm-6 col-sm-6 control-label"><?php  echo $password;   ?></label>
                  </div>
                </div>
				
					<div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">User Contact :</label>
                  <div class="col-sm-6">
				  <label class="col-sm-6 col-sm-6 control-label"><?php  echo $contact;   ?></label>
                  </div>
                </div>
                  ...
                  <div class="col-sm-6">
				  <label class="col-sm-6 col-sm-6 control-label"><?php  echo $status;   ?></label>
                  </div>
                </div>
