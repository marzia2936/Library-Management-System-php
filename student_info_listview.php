        ...
        <div class="row">
          <div class="col-md-12">
            <div class="content-panel">
              <div class="div1"><h4>Student Information List </h4></div>
			  <div class="div2">
					<a href="student_info.php" class="button3">Add Student</a>
			  </div>
              <hr>
			  <?php
						...
						echo "<table class='table'>";
							...
							while($row = mysqli_fetch_array($rec))
							{
								...
								echo "<tr>
										...
										<td align='center'>$student_contact_no</td>
										<td>$student_address</td>				
					
										<td>
									    	<a href='view_student_info.php?student_id=$student_id' class='button4'>View</a> | 
											<a href='edit_student_info.php?student_id=$student_id' class='button1'>Edit</a> | 
