        ...
        <div class="row">
          <div class="col-md-12">
            <div class="content-panel">
              <div class="div1"><h4>Writer Information List</h4></div>
			  <div class="div2">
					<a href="writer_info.php" class="button3">Add Writer</a>
			  </div>
              <hr>
			  <?php
						...
						if(isset($_GET['writer_id'])) 
						{
							...
							$sql = "DELETE FROM writer_info WHERE writer_id='$writer_id'";
							$conn->query($sql);
						...
						echo "<table class='table'>";
							...
							while($row = mysqli_fetch_array($rec))
							{
								...
								echo "<tr>
										...
										<td>$writer_type</td>
										<td align='center'>$writer_email</td>
										<td align='center'>$writer_contact_no</td>
												
					
										<td>
										    <a href='view_writer_info.php?writer_id=$writer_id' class='button4'>View</a> | 

											<a href='edit_writer_info.php?writer_id=$writer_id' class='button1'>Edit</a> | 
											<a href='$_SERVER[SCRIPT_NAME]?writer_id=$writer_id' class='button2' onClick=\"return confirm('Are you sure?')\">Delete</a>
										</td>
									</tr>";
							}	
