...
<?php
	...
	if(isset($_POST['save'])) 
	{
		...
		$sql = "INSERT INTO book_shelf_info (book_shelf_id, book_shelf_name,book_shelf_location) values('$book_shelf_id', '$book_shelf_name','$book_shelf_location')";
  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3>Add Book Shelf Information</h3>
        <!-- BASIC FORM ELELEMNTS -->
        <div class="row mt">
          <div class="col-lg-12">
            <div class="form-panel">
              <h4 class="mb"></h4>
              <form class="form-horizontal style-form" method="post" action="book_shelf_info.php">
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Book Shelf ID :</label>
                  <div class="col-sm-6">
                    <input type="text" class="form-control" name="book_shelf_id">
                  </div>
                </div>
				...
				<div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control" name="book_shelf_name">
                  </div>
                </div>
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control" name="book_shelf_location">
                  </div>
                </div>
