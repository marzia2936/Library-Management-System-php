...
<?php
	...
	if(isset($_POST['save'])) 
	{
		...
		$sql = "INSERT INTO writer_info (writer_id, writer_name, writer_type, writer_email, writer_contact_no) values('$writer_id', '$writer_name', '$writer_type','$writer_email','$writer_contact_no')";
		//echo $sql;die; 
  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3>Add Writer Information</h3>
        <!-- BASIC FORM ELELEMNTS -->
        <div class="row mt">
          <div class="col-lg-12">
            <div class="form-panel">
              <h4 class="mb"></h4>
              <form class="form-horizontal style-form" method="post" action="writer_info.php">
				...
				<div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control" name="writer_type">
                  </div>
                </div>
				...
				<div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control" name="writer_email">
                  </div>
                </div>
				...
				<div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control" name="writer_contact_no">
                  </div>
                </div>
