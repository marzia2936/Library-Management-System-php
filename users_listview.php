        ...
        <div class="row">
          <div class="col-md-12">
            <div class="content-panel">
              <div class="div1"><h4>All User Information List </h4></div>
			  <div class="div2">
					<a href="user_info.php" class="button3">Add User</a>
			  </div>
              <hr>
			  <?php
						...
						echo "<table class='table'>";
							...
							while($row = mysqli_fetch_array($rec))
							{
								...
								echo "<tr>
										...
										<td>
									    	<a href='view_user_info.php?id=$id' class='button4'>View</a> | 
											<a href='edit_user_info.php?id=$id' class='button1'>Edit</a> | 
