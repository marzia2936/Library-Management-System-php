        ...
        <div class="row">
          <div class="col-md-12">
            <div class="content-panel">
              <div class="div1"><h4>Issued Book List for Student</h4></div>
			  <div class="div2">
				<a href="issue_new_book.php" class="button3">Add New Issue Book</a>	
			  </div>
              <hr>
			  <?php
						...
						if(isset($_GET['student_id'])) 
						{
							...
							$sql = "DELETE FROM issue_new_book WHERE student_id='$student_id'";
							$conn->query($sql);
						...
						$sql = "SELECT * FROM issue_new_book";
						//echo $sql;die;
						$rec = $conn->query($sql);
						...
						echo "<table class='table'>";
							...
							while($row = mysqli_fetch_array($rec))
							{
								...
								echo "<tr>
										...
										<td align='center'>$student_library_id</td>
										<td>$student_name</td>
										...
										<td>
									    	<a href='view_issue_book.php?student_id=$student_id' class='button4'>View</a> | 
											<a href='edit_return_book_info.php?student_id=$student_id' class='button1'>Return Book</a> | 
											<a href='$_SERVER[SCRIPT_NAME]?student_id=$student_id' class='button2' onClick=\"return confirm('Are you sure?')\">Delete</a>
										</td>
									</tr>";
							}	
