...
<?php
	...
	if(isset($_GET['role_info_id'])) 
	{
		...
		//echo $_GET['role_info_id'];die;
		$role_info_id = $_GET['role_info_id'];
		
		$sql = "SELECT * FROM role_info WHERE role_info_id='$role_info_id'";
	...
	{
		 $role_info_id    			    = $_POST['role_info_id'];	
		$role_info_name  		            = $_POST['role_info_name'];
	    $role_info_email   	            = $_POST['role_info_email'];
		$role_description   	     = $_POST['role_description'];
		

		$sql = "UPDATE role_info set role_info_id='$role_info_id',role_info_name='$role_info_name',role_info_email='$role_info_email',role_description='$role_description' WHERE role_info_id='$role_info_id'";
		...
		if($result) 
		{
			...
			echo "<meta http-equiv='refresh' content='2;url=role_info_listview.php'>";
			exit();
		}
	}
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
			    	 ...
			    	 <li><a href="member_info_listview.php">Member Information</a></li>
        ...
        <div class="row mt">
          <div class="col-lg-12">
            <div class="form-panel">
              <h4 class="mb"></h4>
              <form class="form-horizontal style-form" method="post" action="edit_role_info.php">
			    
                
			  
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Role Info Name :</label>
                  <div class="col-sm-6">
                    <input type="text" class="form-control" name="role_info_name" value="<?php  echo $role_info_name ;   ?>">
                  </div>
                </div>
				
				
				<div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Role Info Email :</label>
                  <div class="col-sm-6">
                    <input type="text" class="form-control" name="role_info_email" value="<?php  echo $role_info_email;   ?>">
                  </div>
                </div>
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control" name="role_description" value="<?php  echo $role_description;   ?>">
                  </div>
                </div>
				...
				<div class="form-group" align="center">
					...
					<input type="hidden" class="form-control" name="role_info_id" value="<?php  echo $role_info_id;   ?>">
