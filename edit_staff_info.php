            ...
            <div class="form-panel">
              ...
              <form class="form-horizontal style-form" method="post" action="edit_staff_info.php">
				...
				<div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control" name="staff_designation" value="<?php  echo $staff_designation ;   ?>">
                  </div>
                </div>
				...
				<div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control" name="staff_email" value="<?php  echo $staff_email;   ?>">
                  </div>
                </div>
