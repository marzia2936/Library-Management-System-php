        ...
        <div class="row">
          <div class="col-md-12">
            <div class="content-panel">
              <div class="div1"><h4>Book Circulation Information List</h4></div>
			  <div class="div2">
					<a href="book_circulation_info.php" class="button3">Add Issued Book</a>
			  </div>
              <hr>
			  <?php
						...
						if(isset($_GET['book_id'])) 
						{
							...
							$sql = "DELETE FROM book_circulation_info WHERE book_id='$book_id'";
							$conn->query($sql);
						...
						$sql = "SELECT * FROM book_circulation_info";
						//echo $sql;die;
						$rec = $conn->query($sql);
						...
						echo "<table class='table'>";
							...
							while($row = mysqli_fetch_array($rec))
							{
								...
								echo "<tr>
										...
										<td align='center'>$book_edition</td>
										<td align='center'>$publication_year</td>
		
					
										<td>
											<a href='view_book_circulation_info.php?book_id=$book_id' class='button4'>View</a> | 

											<a href='edit_book_circulation_info.php?book_id=$book_id' class='button1'>Edit</a> | 
