...
<?php
	...
	if(isset($_POST['save'])) 
	{
		...
		$student_address 	    = $_POST['student_address'];
			...
			//echo $sql;die;
		$sql = "INSERT INTO student_info(student_id,student_library_id,student_name,student_email,student_contact_no,student_address) values('$student_id','$student_library_id','$student_name','$student_email','$student_contact_no','$student_address')";
        ...
        <div class="row mt">
          <div class="col-lg-12">
            <div class="form-panel">
              <h4 class="mb"></h4>
              <form class="form-horizontal style-form" method="post" action="student_info.php">
			  ...
			  <div class="form-group">
				...
				<div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control" name="student_contact_no">
                  </div>
                </div>
