...
<?php
	...
	if(isset($_POST['save'])) 
	{
	   ...
	   $isbn_number 	        = $_POST['isbn_number'];
		...
		$sql = "INSERT INTO book_circulation_info ( book_id, isbn_number, book_title, book_author, book_edition, publication_year )    values( '$book_id','$isbn_number','$book_title','$book_author', '$book_edition','$publication_year')";
		...
		if($result == 1)
		{
			...
			header("Location: book_circulation_info_listview.php");
		}
        ...
        <div class="row mt">
          <div class="col-lg-12">
            <div class="form-panel">
              <h4 class="mb"></h4>
              <form class="form-horizontal style-form" method="post" action="book_circulation_info.php">
