...
if(isset($_POST['update'])) 
	{
		...
		$sql = "UPDATE staff_info set staff_id='$staff_id',staff_name='$staff_name',staff_designation='$staff_designation',staff_email='$staff_email',staff_contact_no='$staff_contact_no',staff_address='$staff_address' WHERE staff_id='$staff_id'";
		...
		if($result) 
		{
			...
			echo "<meta http-equiv='refresh' content='2;url=staff_info_listview.php'>";
			exit();
		}
	}
        ...
        <div class="row mt">
          <div class="col-lg-12">
            <div class="form-panel">
              <h4 class="mb"></h4>
              <form class="form-horizontal style-form" method="post" action="edit_staff_info.php">
			    
                   <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Staff ID :</label>
                  <div class="col-sm-6">
				  <label class="col-sm-6 col-sm-6 control-label"><?php  echo $staff_id;   ?></label>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
				  	<label class="col-sm-6 col-sm-6 control-label"><?php  echo $staff_name;   ?></label>
				...
				<div class="form-group">
                  ...
                  <div class="col-sm-6">
				  	<label class="col-sm-6 col-sm-6 control-label"><?php  echo $staff_designation;   ?></label>
                  </div>
                </div>
                  ...
                  <div class="col-sm-6">
				  	<label class="col-sm-6 col-sm-6 control-label"><?php  echo $staff_email;   ?></label>
                  </div>
                </div>
                  ...
                  <div class="col-sm-6">
				  	<label class="col-sm-6 col-sm-6 control-label"><?php  echo $staff_contact_no;   ?></label>
                  </div>
                </div>		
