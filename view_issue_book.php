  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3>View Issued Book Information</h3>
              ...
              <form class="form-horizontal style-form" method="post" action="edit_return_book_info.php">
				...
				<div class="form-group">
                  ...
                  <div class="col-sm-6">
					...
					<label class="col-sm-6 col-sm-6 control-label"><?php  echo $issue_date;   ?></label>
                  </div>
                </div>
				 ...
				 <div class="form-group">
                  ...
                  <div class="col-sm-6">
					...
					<label class="col-sm-6 col-sm-6 control-label"><?php  echo $return_date;   ?></label>
                  </div>
                </div>
