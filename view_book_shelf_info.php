            ...
            <div class="form-panel">
              ...
              <form class="form-horizontal style-form" method="post" action="edit_book_shelf_info.php">
				 ...
				 <div class="form-group">
                  ...
                  <div class="col-sm-6">
				  <label class="col-sm-6 col-sm-6 control-label"><?php  echo $book_shelf_id;   ?></label>
                  </div>
                </div>
                  ...
                  <div class="col-sm-6">
				  <label class="col-sm-6 col-sm-6 control-label"><?php  echo $book_shelf_name;   ?></label>
                  </div>
                </div>
				...
				<div class="form-group">
                  ...
                  <div class="col-sm-6">
				  <label class="col-sm-6 col-sm-6 control-label"><?php  echo $book_shelf_location;   ?></label>
                  </div>
                </div>		
