...
<?php
	...
	if(isset($_GET['book_id'])) 
	{
		...
		$sql = "SELECT * FROM book_circulation_info WHERE book_id='$book_id'";
	...
	if(isset($_POST['update'])) 
	{
		...
		$sql = "UPDATE book_circulation_info set book_id='$book_id',isbn_number='$isbn_number',book_title='$book_title',book_author='$book_author',book_edition='$book_edition',publication_year='$publication_year' WHERE book_id='$book_id'";
		...
		if($result) 
		{
			...
			echo "<meta http-equiv='refresh' content='2;url=book_circulation_info_listview.php'>";
			exit();
		}
	}
  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3>Book Circulation Information</h3>
        <!-- BASIC FORM ELELEMNTS -->
        <div class="row mt">
          <div class="col-lg-12">
            <div class="form-panel">
              <h4 class="mb"></h4>
              <form class="form-horizontal style-form" method="post" action="edit_book_circulation_info.php">
