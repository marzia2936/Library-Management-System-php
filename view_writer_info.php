          ...
          <div class="col-lg-12">
            <div class="form-panel">
			  ...
			  <div class="form-group">
                  ...
                  <div class="col-sm-6">
				  <label class="col-sm-6 col-sm-6 control-label"><?php  echo $writer_id;   ?></label>
                  </div>
                </div> 
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
				  	<label class="col-sm-6 col-sm-6 control-label"><?php  echo $writer_name;   ?></label>
                  </div>
                </div>
				...
				<div class="form-group">
                  ...
                  <div class="col-sm-6">
				  	<label class="col-sm-6 col-sm-6 control-label"><?php  echo $writer_type;   ?></label>
                  </div>
                </div>
				...
				<div class="form-group">
                  ...
                  <div class="col-sm-6">
				  	<label class="col-sm-6 col-sm-6 control-label"><?php  echo $writer_email;   ?></label>
                  </div>
                </div>
                  ...
                  <div class="col-sm-6">
				  	<label class="col-sm-6 col-sm-6 control-label"><?php  echo $writer_contact_no;   ?></label>
                  </div>
                </div>
