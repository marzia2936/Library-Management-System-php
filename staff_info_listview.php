        ...
        <div class="row">
          <div class="col-md-12">
            <div class="content-panel">
              <div class="div1"><h4>Staff Information List</h4></div>
			  <div class="div2">
					<a href="staff_info.php" class="button3">Add New Staff</a>
			  </div>
              <hr>
			  <?php
						...
						if(isset($_GET['staff_id'])) 
						{
							...
							$sql = "DELETE FROM staff_info WHERE staff_id='$staff_id'";
							$conn->query($sql);
							...
							//echo $sql;die;						
								...
								echo "<tr>
								       <td align='center'>$i</td>
										...
										<td>
										    <a href='view_staff_info.php?staff_id=$staff_id' class='button4'>View</a> |
