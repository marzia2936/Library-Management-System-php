            ...
            <div class="form-panel">
			 ...
			 <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control" name="sup_name" value="<?php  echo $sup_name ;   ?>">
                  </div>
                </div>
				...
				<div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control" name="sup_email" value="<?php  echo $sup_email;   ?>">
                  </div>
                </div>
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control" name="sup_contact_no" value="<?php  echo $sup_contact_no;   ?>">
                  </div>
                </div>
				...
				<div class="form-group" align="center">
					...
					<input type="hidden" class="form-control" name="sup_id" value="<?php  echo $sup_id;   ?>">
