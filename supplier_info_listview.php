        ...
        <div class="row">
          <div class="col-md-12">
            <div class="content-panel">
              <div class="div1"><h4>Supplier Information List</h4></div>
			  <div class="div2">
					<a href="supplier_info.php" class="button3">Add Supplier</a>
				</div>
              <hr>
			  <?php
						...
						{
							$member_id = $_GET['sup_id'];
							
							$sql = "DELETE FROM supplier_info WHERE sup_id='$sup_id'";
							$conn->query($sql);
						...
						echo "<table class='table'>";
							...
							while($row = mysqli_fetch_array($rec))
							{
								...
								echo "<tr>
										...
										<td align='center'>$sup_name</td>
										
										<td align='center'>$sup_email</td>
										<td align='center'>$sup_contact_no</td>
												
					
										<td>
											<a href='view_supplier_info.php?sup_id=$sup_id' class='button4'>View</a> | 
											<a href='edit_supplier_info.php?sup_id=$sup_id' class='button1'>Edit</a> | 
											<a href='$_SERVER[SCRIPT_NAME]?sup_id=$sup_id' class='button2' onClick=\"return confirm('Are you sure?')\">Delete</a>
										</td>
									</tr>";
							}	
