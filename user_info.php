...
<?php
	...
	if(isset($_POST['save'])) 
	{
		...
		$sql = "INSERT INTO user_info ( id,username,password,contact,status) values('$id','$username','$password','$contact','$status')";
        ...
        <div class="row mt">
          <div class="col-lg-12">
            <div class="form-panel">
              <h4 class="mb"></h4>
              <form class="form-horizontal style-form" method="post" action="user_info.php">
